...
export type Invoice = { id: string; number: string; customer: string; issueDate: string; dueDate: string; status: InvoiceStatus; lines: InvoiceLine[]; discount: number; payments: InvoicePayment[]; sourceQuote?: string; creditNotes: string[] };
